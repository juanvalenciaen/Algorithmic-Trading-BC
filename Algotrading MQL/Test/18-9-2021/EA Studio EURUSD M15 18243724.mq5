...
input int Stop_Loss   = 97; // Stop Loss (pips)
input int Take_Profit = 88; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Candle Color -----
input int Ind0Param0 = 10; // Min body height [pips]
input int Ind0Param1 = 1; // Consecutive candles
static input string Ind1 = "------------";// ----- ADX -----
input int Ind1Param0 = 34; // Period
input int Ind1Param1 = 35; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 18243724; // Magic Number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"stopLoss":97,"takeProfit":88,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[10,1,0,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[34,35,0,0,0,0]}]} */
