...
input int Stop_Loss   = 33; // Stop Loss (pips)
input int Take_Profit = 0; // Take Profit (pips)
static input string Ind0 = "------------";// ----- RSI -----
input int Ind0Param0 = 18; // Period
input int Ind0Param1 = 38; // Level
static input string Ind1 = "------------";// ----- Standard Deviation -----
input int Ind1Param0 = 18; // Period
input double Ind1Param1 = 0.0002; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 18596603; // Magic Number
...
int OnInit()
  {
   ...
   ind1handler = iStdDev(NULL,0,Ind1Param0,0,MODE_SMA,PRICE_CLOSE);
...
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":33,"takeProfit":15,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[5,3,0,0,0],"numValues":[18,38,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[3,3,0,0,0],"numValues":[18,0.0002,0,0,0,0]}]} */
