...
int OnInit()
  {
   ...
   ind0handler = iWPR(NULL,0,Ind0Param0);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; NZDUSD; M1 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":25,"takeProfit":30,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[3,0,0,0,0],"numValues":[11,-20,0,0,0,0]}],"closeFilters":[{"name":"Bollinger Bands","listIndexes":[0,3,0,0,0],"numValues":[26,3.77,0,0,0,0]}]} */
