...
input int Stop_Loss   = 37; // Stop Loss (pips)
input int Take_Profit = 0; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Average -----
input int Ind0Param0 = 14; // Period
input int Ind0Param1 = 0; // Shift
static input string Ind1 = "------------";// ----- Moving Averages Crossover -----
input int Ind1Param0 = 15; // Fast MA period
input int Ind1Param1 = 42; // Slow MA period
static input string Ind2 = "------------";// ----- Moving Averages Crossover -----
input int Ind2Param0 = 12; // Fast MA period
input int Ind2Param1 = 30; // Slow MA period

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 18665548; // Magic Number
...
int OnInit()
  {
   ...
   ind0handler = iMA(NULL,0,Ind0Param0,Ind0Param1,MODE_SMA,PRICE_CLOSE);
   ind1handler = iMA(NULL,0,Ind1Param0,0,MODE_SMA,PRICE_CLOSE);
   ind11handler= iMA(NULL,0,Ind1Param1,0,MODE_SMA,PRICE_CLOSE);
...
void ManageOpen()
  {
   ...
   double ind1buffer1[]; CopyBuffer(ind11handler,0,1,2,ind1buffer1);
...
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":37,"takeProfit":47,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[5,0,3,0,0],"numValues":[14,0,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[0,0,0,0,0],"numValues":[15,42,0,0,0,0]}],"closeFilters":[{"name":"Moving Averages Crossover","listIndexes":[0,0,0,0,0],"numValues":[12,30,0,0,0,0]}]} */
