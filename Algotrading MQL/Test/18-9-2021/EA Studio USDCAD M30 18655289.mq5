...
input int Stop_Loss   = 95; // Stop Loss (pips)
input int Take_Profit = 0; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Average True Range -----
input int Ind0Param0 = 7; // Period
input double Ind0Param1 = 0.0070; // Level
static input string Ind1 = "------------";// ----- Bollinger Bands -----
input int Ind1Param0 = 24; // Period
input double Ind1Param1 = 2.00; // Deviation
static input string Ind2 = "------------";// ----- Williams' Percent Range -----
input int Ind2Param0 = 25; // Period
input int Ind2Param1 = -60; // Level
static input string Ind3 = "------------";// ----- Commodity Channel Index -----
input int Ind3Param0 = 35; // Period
input int Ind3Param1 = -79; // Level
static input string Ind4 = "------------";// ----- Moving Average -----
input int Ind4Param0 = 9; // Period
input int Ind4Param1 = 0; // Shift

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 18655289; // Magic Number
...
int OnInit()
  {
   ...
   ind0handler = iATR(NULL,0,Ind0Param0);
   ind1handler = iBands(NULL,0,Ind1Param0,0,Ind1Param1,PRICE_CLOSE);
   ind2handler = iWPR(NULL,0,Ind2Param0);
   ind3handler = iCCI(NULL,0,Ind3Param0,PRICE_TYPICAL);
   ind4handler = iMA(NULL,0,Ind4Param0,Ind4Param1,MODE_SMA,PRICE_CLOSE);
...
void ManageOpen()
  {
   ...
   bool ind0long  = ind0val1 < Ind0Param1 - sigma;
   bool ind0short = ind0long;

   double ind1buffer0[]; CopyBuffer(ind1handler,1,1,2,ind1buffer0);
   double ind1buffer1[]; CopyBuffer(ind1handler,2,1,2,ind1buffer1);
   ...
   bool ind3short = ind3val1 > -Ind3Param1 + sigma;
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; USDCAD; M30 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":95,"takeProfit":85,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Average True Range","listIndexes":[3,0,0,0,0],"numValues":[7,0.007,0,0,0,0]},{"name":"Bollinger Bands","listIndexes":[5,3,0,0,0],"numValues":[24,2,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[4,0,0,0,0],"numValues":[25,-60,0,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[3,5,0,0,0],"numValues":[35,-79,0,0,0,0]}],"closeFilters":[{"name":"Moving Average","listIndexes":[4,0,3,0,0],"numValues":[9,0,0,0,0,0]}]} */
