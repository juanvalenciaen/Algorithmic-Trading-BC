...
input double Ind0Param0 = -0.0011; // Level
static input string Ind1 = "------------";// ----- Awesome Oscillator -----
input double Ind1Param0 = -0.0006; // Level
static input string Ind2 = "------------";// ----- DeMarker -----
input int Ind2Param0 = 22; // Period
input double Ind2Param1 = 0.82; // Level
static input string Ind3 = "------------";// ----- Envelopes -----
input int Ind3Param0 = 18; // Period
input double Ind3Param1 = 0.84; // Deviation %

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 23572336; // Magic Number
...
int OnInit()
  {
   ...
   ind0handler = iAC(NULL,0);
   ind1handler = iAO(NULL,0);
...
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":81,"takeProfit":87,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Accelerator Oscillator","listIndexes":[4,0,0,0,0],"numValues":[-0.0011,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-0.0006,0,0,0,0,0]}],"closeFilters":[{"name":"DeMarker","listIndexes":[2,0,0,0,0],"numValues":[22,0.82,0,0,0,0]},{"name":"Envelopes","listIndexes":[4,3,0,0,0],"numValues":[18,0.84,0,0,0,0]}]} */
